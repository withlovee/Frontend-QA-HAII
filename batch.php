				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<div class="form-inline filters">
							<div class="form-group">
								<select name="" id="" class="form-control" multiple>
									<option value="">Missing pattern</option>
									<option value="">Outlier</option>
									<option value="">Outlier + Homogeneity</option>
								</select>
							</div>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<div class="form-inline filters">
							<div class="form-group">
								<select name="" id="" class="form-control" multiple>
									<option value="" selected>Missing pattern</option>
								</select>
							</div>
						</div>
					</div>
