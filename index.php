<?php include('header.php'); ?>
		<div class="page-header">
			...
			<div class="btn-group right">
				...
				<button type="button" class="btn btn-default active">24 ชั่วโมงที่ผ่านมา</button>
			</div>
			<div class="clear"></div>
		</div>
		<!--/.page-header -->
			...
			<div class="tab-pane active" id="water">
				...
				<div class="list-group updates">
					<div class="list-group-item unread" data-toggle="modal" data-target="#detail">
						<div class="wrapper">
							<div class="text-wrapper">
								...
								<table class="list-group-item-heading">
									<tr>
										<td width="200">สถานีป่าสัก2 (PAS002)</td>
										<td width="120">Missing Gap</td>
										<td>NA แก้เป็น 2.5</td>
									</tr>
								</table>
							</div>
							<div class="operations">
								...
								<span class="text">Mask as Read</span>
					...
					<div class="list-group-item unread">
						<div class="wrapper">
							<div class="text-wrapper">
								...
								<table class="list-group-item-heading">
									<tr>
										<td width="200">สถานีน่าน6 (NAN006)</td>
										<td width="120">Boundary</td>
										<td>0.86 แก้เป็น 1</td>
									</tr>
								</table>
							</div>
							<div class="operations">
					...
					<div class="list-group-item unread">
						<div class="wrapper">
							<div class="text-wrapper">
								<p class="list-group-item-text">2012-03-17 ถึง 2012-03-30 (13 วัน)</p>
								<table class="list-group-item-heading">
									<tr>
										<td width="200">สถานีชี1 (CHI001)</td>
										<td width="120">Flat Value</td>
										<td>111.91 แก้เป็น 100</td>
									</tr>
								</table>
							</div>
							<div class="operations">
